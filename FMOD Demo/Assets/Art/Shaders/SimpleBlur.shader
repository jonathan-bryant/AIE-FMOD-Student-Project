...
////// Lighting:
                ...
                float3 finalColor = ((((_Tint.rgb+tex2D( _GrabTexture, __screenPos).rgb)+tex2D( _GrabTexture, float2((__screenPosU+_offset),__screenPosV)).rgb+tex2D( _GrabTexture, float2(__screenPosU,(__screenPosV+_offset))).rgb+tex2D( _GrabTexture, float2((__screenPosU-_offset),__screenPosV)).rgb+tex2D( _GrabTexture, float2(__screenPosU,(__screenPosV-_offset))).rgb)+(tex2D( _GrabTexture, float2((__screenPosU+_offset),(__screenPosV+_offset))).rgb+tex2D( _GrabTexture, float2((__screenPosU+_offset),(__screenPosV-_offset))).rgb+tex2D( _GrabTexture, float2((__screenPosU-_offset),(__screenPosV+_offset))).rgb+tex2D( _GrabTexture, float2((__screenPosU-_offset),(__screenPosV-_offset))).rgb))/9.0);
