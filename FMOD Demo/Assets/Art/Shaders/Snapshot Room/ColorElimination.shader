...
////// Emissive:
                ...
                float node_3529 = 1.0;
                float3 emissive = (sceneColor.rgb*pow(saturate((node_3529 + ( ((_Density*(sceneZ-partZ)) - node_7797) * (0.0 - node_3529) ) / ((_node_7887.rgb+_node_7887.a) - node_7797))),_FadePower));
