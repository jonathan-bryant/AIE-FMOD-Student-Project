...
////// Emissive:
                ...
                float node_3529 = 1.0;
                float3 emissive = (tex2D( _GrabTexture, i.screenPos.rg).rgb*pow(saturate((node_3529 + ( ((_Density*(sceneZ-partZ)) - node_7797) * (0.0 - node_3529) ) / ((_Color.rgb+_Color.a) - node_7797))),_FadePower));
