...
Shader "Shader Forge/WaterEffect" {
    Properties {
        ...
        _TransitionDistance ("Transition Distance", Float ) = 87
    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float4 node_8512 = _Time + _TimeEditor;
                float node_9980_ang = node_8512.g;
                ...
                float4 node_9294 = tex2Dlod(_Height,float4(TRANSFORM_TEX(node_9980, _Height),0.0,0));
                float node_8682 = 1.0;
                float2 node_817 = (node_9980*node_8682);
                float4 node_2180 = tex2Dlod(_Height,float4(TRANSFORM_TEX(node_817, _Height),0.0,0));
                float node_5956 = saturate(pow((distance(mul(_Object2World, v.vertex).rgb,_WorldSpaceCameraPos)/_TransitionDistance),_Falloff));
                float node_5788_ang = node_8512.g;
                ...
                float4 node_3801 = tex2Dlod(_Height2,float4(TRANSFORM_TEX(node_5788, _Height2),0.0,0));
                float2 node_9193 = (node_5788*node_8682);
                float4 node_5100 = tex2Dlod(_Height2,float4(TRANSFORM_TEX(node_9193, _Height2),0.0,0));
                float node_1240 = (lerp(node_9294.r,node_2180.r,node_5956)*lerp(node_3801.r,node_5100.r,node_5956));
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float4 node_8512 = _Time + _TimeEditor;
                float node_807_ang = node_8512.g;
                ...
                float3 node_8177 = UnpackNormal(tex2D(_NormalMap2,TRANSFORM_TEX(node_807, _NormalMap2)));
                float node_6432 = 10.0;
                float2 node_2904 = (node_807*node_6432);
                float3 node_5643 = UnpackNormal(tex2D(_NormalMap2,TRANSFORM_TEX(node_2904, _NormalMap2)));
                float node_5956 = saturate(pow((distance(i.posWorld.rgb,_WorldSpaceCameraPos)/_TransitionDistance),_Falloff));
                float node_9408_ang = node_8512.g;
                ...
                float3 node_1274 = UnpackNormal(tex2D(_NormalMap,TRANSFORM_TEX(node_9408, _NormalMap)));
                float2 node_4188 = (node_9408*node_6432);
                float3 _BumpMap = UnpackNormal(tex2D(_NormalMap,TRANSFORM_TEX(node_4188, _NormalMap)));
                float3 node_3096 = normalize((lerp(node_8177.rgb,node_5643.rgb,node_5956)*lerp(node_1274.rgb,_BumpMap.rgb,node_5956)));
                float3 normalLocal = node_3096;
                float3 normalDirection = normalize(mul( normalLocal, tangentTransform )); // Perturbed normals
                float3 viewReflectDirection = reflect( -viewDirection, normalDirection );
                float __Refraction = (i.normalDir.g*_RefractionIntensity);
                float node_4714 = __Refraction;
                float2 sceneUVs = float2(1,grabSign)*i.screenPos.xy*0.5+0.5 + float2(node_4714,node_4714);
...
/////// Diffuse:
                ...
                float4 node_9294 = tex2D(_Height,TRANSFORM_TEX(node_9980, _Height));
                float node_8682 = 1.0;
                float2 node_817 = (node_9980*node_8682);
                ...
                float4 node_3801 = tex2D(_Height2,TRANSFORM_TEX(node_5788, _Height2));
                float2 node_9193 = (node_5788*node_8682);
...
/// Final Color:
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.tangentDir = normalize( mul( _Object2World, float4( v.tangent.xyz, 0.0 ) ).xyz );
                o.bitangentDir = normalize(cross(o.normalDir, o.tangentDir) * v.tangent.w);
                float4 node_6170 = _Time + _TimeEditor;
                float node_9980_ang = node_6170.g;
                float node_9980_spd = (-1*__heightSpeed);
                float node_9980_cos = cos(node_9980_spd*node_9980_ang);
                float node_9980_sin = sin(node_9980_spd*node_9980_ang);
                float2 node_9980_piv = float2(0.5,0.5);
                ...
                float4 node_2180 = tex2Dlod(_Height,float4(TRANSFORM_TEX(node_817, _Height),0.0,0));
                float node_5956 = saturate(pow((distance(mul(_Object2World, v.vertex).rgb,_WorldSpaceCameraPos)/_TransitionDistance),_Falloff));
                float node_5788_ang = node_6170.g;
                float node_5788_spd = __heightSpeed;
                float node_5788_cos = cos(node_5788_spd*node_5788_ang);
                float node_5788_sin = sin(node_5788_spd*node_5788_ang);
                float2 node_5788_piv = float2(0.5,0.5);
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 viewDirection = normalize(_WorldSpaceCameraPos.xyz - i.posWorld.xyz);
                float4 node_6170 = _Time + _TimeEditor;
                float node_807_ang = node_6170.g;
                float node_807_spd = (-1*__normalSpeed);
                float node_807_cos = cos(node_807_spd*node_807_ang);
                float node_807_sin = sin(node_807_spd*node_807_ang);
                float2 node_807_piv = float2(0.5,0.5);
                ...
                float3 node_5643 = UnpackNormal(tex2D(_NormalMap2,TRANSFORM_TEX(node_2904, _NormalMap2)));
                float node_5956 = saturate(pow((distance(i.posWorld.rgb,_WorldSpaceCameraPos)/_TransitionDistance),_Falloff));
                float node_9408_ang = node_6170.g;
                float node_9408_spd = __normalSpeed;
                float node_9408_cos = cos(node_9408_spd*node_9408_ang);
                float node_9408_sin = sin(node_9408_spd*node_9408_ang);
                float2 node_9408_piv = float2(0.5,0.5);
...
/// Final Color:
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.uv2 = v.texcoord2;
                o.normalDir = UnityObjectToWorldNormal(v.normal);
                float4 node_5170 = _Time + _TimeEditor;
                float node_9980_ang = node_5170.g;
                float node_9980_spd = (-1*__heightSpeed);
                float node_9980_cos = cos(node_9980_spd*node_9980_ang);
                float node_9980_sin = sin(node_9980_spd*node_9980_ang);
                float2 node_9980_piv = float2(0.5,0.5);
                ...
                float4 node_2180 = tex2Dlod(_Height,float4(TRANSFORM_TEX(node_817, _Height),0.0,0));
                float node_5956 = saturate(pow((distance(mul(_Object2World, v.vertex).rgb,_WorldSpaceCameraPos)/_TransitionDistance),_Falloff));
                float node_5788_ang = node_5170.g;
                float node_5788_spd = __heightSpeed;
                float node_5788_cos = cos(node_5788_spd*node_5788_ang);
                float node_5788_sin = sin(node_5788_spd*node_5788_ang);
                float2 node_5788_piv = float2(0.5,0.5);
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.uv2 = v.texcoord2;
                o.normalDir = UnityObjectToWorldNormal(v.normal);
                float4 node_9494 = _Time + _TimeEditor;
                float node_9980_ang = node_9494.g;
                float node_9980_spd = (-1*__heightSpeed);
                float node_9980_cos = cos(node_9980_spd*node_9980_ang);
                float node_9980_sin = sin(node_9980_spd*node_9980_ang);
                float2 node_9980_piv = float2(0.5,0.5);
                ...
                float4 node_2180 = tex2Dlod(_Height,float4(TRANSFORM_TEX(node_817, _Height),0.0,0));
                float node_5956 = saturate(pow((distance(mul(_Object2World, v.vertex).rgb,_WorldSpaceCameraPos)/_TransitionDistance),_Falloff));
                float node_5788_ang = node_9494.g;
                float node_5788_spd = __heightSpeed;
                float node_5788_cos = cos(node_5788_spd*node_5788_ang);
                float node_5788_sin = sin(node_5788_spd*node_5788_ang);
                float2 node_5788_piv = float2(0.5,0.5);
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float node_807_ang = node_9494.g;
                float node_807_spd = (-1*__normalSpeed);
                float node_807_cos = cos(node_807_spd*node_807_ang);
                float node_807_sin = sin(node_807_spd*node_807_ang);
                float2 node_807_piv = float2(0.5,0.5);
                ...
                float2 node_2904 = (node_807*node_6432);
                float3 node_5643 = UnpackNormal(tex2D(_NormalMap2,TRANSFORM_TEX(node_2904, _NormalMap2)));
                float node_9408_ang = node_9494.g;
                float node_9408_spd = __normalSpeed;
                float node_9408_cos = cos(node_9408_spd*node_9408_ang);
                float node_9408_sin = sin(node_9408_spd*node_9408_ang);
                float2 node_9408_piv = float2(0.5,0.5);
